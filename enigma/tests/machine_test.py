...
class MachineTest(unittest.TestCase):
    def test_encoding_I_II_III_rB_010101_AAZ(self):
        machine = Machine(
    ...
    def test_encoding_I_II_III_rB_010101_AAZ_long(self):
        machine = Machine(
            [Rotors["I"](), Rotors["II"](), Rotors["III"]()],
            Rotors["B"]()
        )
    ...
    def test_encoding_II_III_IV_rC_101505_ABC_long(self):
        machine = Machine(
    ...
    def test_encoding_II_III_IV_rC_111519_EVZ_long(self):
        machine = Machine(
            [Rotors["II"](), Rotors["III"](), Rotors["IV"]()],
            Rotors["C"]()
        )
    ...
    def test_encoding_I_II_III_rB_010101_AAA(self):
        machine = Machine(
            [Rotors["I"](), Rotors["II"](), Rotors["III"]()],
            Rotors["B"]()
        )
    ...
    def test_encoding_I_II_III_rB_010101_QEV(self):
        machine = Machine(
            [Rotors["I"](), Rotors["II"](), Rotors["III"]()],
            Rotors["B"]()
        )
    ...
    def test_encoding_IV_V_BETA_rB_140924_AAA(self):
        machine = Machine(
    ...
    def test_encoding_I_II_III_IV_rC_07111519_QEVZ(self):
        machine = Machine(
    ...
    def test_encoding_I_II_III_rB_071115_QEV(self):
        machine = Machine(
            [Rotors["I"](), Rotors["II"](), Rotors["III"]()],
            Rotors["B"]()
        )
